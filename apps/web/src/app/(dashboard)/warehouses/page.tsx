  ...
  return (
    <div className="space-y-4 sm:space-y-6">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h1 className="text-2xl sm:text-3xl font-bold tracking-tight">Kho váº­t lÃ½</h1>
          <p className="text-sm sm:text-base text-muted-foreground">Quáº£n lÃ½ kho theo chi nhÃ¡nh, vá»‹ trÃ­ lÆ°u trá»¯ â€¢ <strong>{total}</strong> kho</p>
        </div>
      </div>
      <Card>
        <CardHeader><CardTitle>Danh sÃ¡ch kho</CardTitle></CardHeader>
        <CardContent>
          {warehouses.length === 0 ? (
            <div className="text-center py-8 text-muted-foreground">ChÆ°a cÃ³ kho nÃ o.</div>
          ) : (
            <WarehouseTable
