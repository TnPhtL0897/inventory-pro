    ...
    <div className="space-y-4 sm:space-y-6">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="text-sm sm:text-base text-muted-foreground">Phiểu chuyá»ƒn kho ná»™i bá»™ â€¢ <strong>{total}</strong> phiểu</p>
        </div>
        <TransferFormClient />
      </div>
      <Card>
        <CardHeader><CardTitle>Danh sách phiểu chuyá»ƒn</CardTitle></CardHeader>
        <CardContent>
