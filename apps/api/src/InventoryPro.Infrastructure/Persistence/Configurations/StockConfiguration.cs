...
public class StockConfiguration : IEntityTypeConfiguration<Stock>
{
    ...
    {
        b.ToTable("stock");
        // Composite PK mirror SQL (batch_no, serial_no có thể NULL)
        b.HasKey(x => new
        {
            x.BranchId,
            x.WarehouseId,
        ...
        b.Property(x => x.Quantity).HasColumnName("quantity").HasPrecision(18, 4).HasDefaultValue(0);
        b.Property(x => x.ReservedQty).HasColumnName("reserved_qty").HasPrecision(18, 4).HasDefaultValue(0);
        b.Property(x => x.AvgCost).HasColumnName("avg_cost").HasPrecision(18, 4).HasDefaultValue(0);
        ...
        b.HasIndex(x => new { x.WarehouseId, x.ProductId });
    }
}
...
public class StockMovementConfiguration : IEntityTypeConfiguration<StockMovement>
{
    ...
    {
        // Mirror SQL: partition theo created_at, PK (id, created_at)
        ...
        b.Property(x => x.Status)
            ...
            .HasMaxLength(20)
            .IsRequired();
        b.Property(x => x.Quantity).HasColumnName("quantity").HasPrecision(18, 4).IsRequired();
        ...
        b.HasIndex(x => new { x.TenantId, x.ProductId, x.CreatedAt });
